...
export const vehicles: VehicleDetail[] = [
  ...
  },
  {
    ...
    acceleration: 8.7,
    description:
      "The everyday favorite. Efficient, reliable, and comfortable — the sedan everyone recognizes and nobody worries about.",
    gallery: [car1, car2, car4, car3],
    features: ["Honda Sensing", "Apple CarPlay", "Dual-zone climate", "Cloth seats"],
  },
  {
    id: "corolla",
    name: "Corolla",
    ...
    acceleration: 9.4,
    description:
      "Best-selling sedan on the planet, for a reason. Toyota reliability, low running costs, and zero surprises.",
    gallery: [car3, car1, car2, car4],
    features: ["Toyota Safety Sense", "Backup camera", "Bluetooth audio", "Cruise control"],
  },
  {
    id: "hb20",
    name: "HB20",
    ...
    acceleration: 10.5,
    description:
      "Brazil's most popular car. Compact, fuel-efficient, and the easiest way into the Skyline fleet.",
    gallery: [car2, car4, car1, car3],
    features: ["Touchscreen multimedia", "Rear parking sensors", "Keyless entry", "Air conditioning"],
  },
];
